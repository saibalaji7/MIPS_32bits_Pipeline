...
HD_PWD='C:/Vivado_Projects/MIPS_32bits_Pipeline/MIPS_32bits_Pipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPSpipeline.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIPSpipeline.tcl
